      ...
      <div className="max-w-7xl mx-auto px-8 mt-12">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-1/3 space-y-12">
            ...
            <div>
              ...
              <p className="text-lg">
                {/* TODO: Insert official KYU? Instagram URL and handle here (e.g. https://instagram.com/kyuwear) */}
                <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:text-gray-300 transition-colors inline-flex items-center gap-2">
        ...
        <div className="mt-40 border-t border-white/10 pt-20">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            ...
            {/* TODO: Insert official KYU? Instagram URL and handle here (e.g. https://instagram.com/kyuwear) */}
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="mt-6 md:mt-0 px-6 py-3 border border-white/20 rounded-full flex items-center gap-2 hover:bg-white/5 transition-colors uppercase tracking-widest text-sm">
              <InstagramIcon className="w-4 h-4" /> Instagram
            </a>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[1, 2, 3, 4].map((i) => (
              /* TODO: Insert official KYU? Instagram URL here */
              <a key={i} href="https://instagram.com" target="_blank" rel="noreferrer" className="group relative aspect-square bg-[#111] overflow-hidden block">
                <img 
